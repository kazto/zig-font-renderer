...
- Return explicit errors for malformed or unresolvable composite placement records.
...
- Reject point-matched composite placement when referenced parent or component point indexes cannot be resolved.
